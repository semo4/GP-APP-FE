...
const TutorialPage = () => {
  ...
  const steps = [
    ...
    { 
      image: step5, 
      title: "Edit · Export · Add Images · Browse Articles", 
      description: "Here you can edit your article, export it as a Word document, add images, start a new article that's related to your topic, or go back."
    },
  ];
